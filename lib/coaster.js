...
Work.prototype.render = function(res,template_name, userArgs){
    ...
    fs.readFile(template_path, this._config.encoding, function(err, template_content) {
        // actual error handling should go here;
        if (err) console.log(err);
        else {
            var tpl = _.template(template_content);
            var compiled_template = tpl(userArgs);
